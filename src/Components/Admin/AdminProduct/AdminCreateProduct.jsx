...
export default function AdminCreateProduct() {
  ...
  let [errorMessage, setErrorMessage] = useState({
    ...
    basePrice: "BasePrice is Mandatory",
            ...
            <form onSubmit={postData}>
              ...
              <div className="row">
                <div className="col-md-6 mb-3">
                  <label>Color*</label>
                  <input type="text" name="color" onChange={getInputData} placeholder="Product Color"
                    className={`form-control ${show && errorMessage.color ? "border-danger" : "border-primary"} border-2`}/>
                  {show && errorMessage.color ? (<p className="text-danger text-capitalize">{errorMessage.color}</p>) : ("")}
                </div>
                <div className="col-md-6 mb-3">
                  <label>Size*</label>
                  <input type="text" name="size" onChange={getInputData}
              ...
              <div className="row">
                <div className="col-md-6 mb-3">
                  ...
                  <input type="number" name="quantity" onChange={getInputData} placeholder="Product Stock Quantity" 
                  className={`form-control ${
