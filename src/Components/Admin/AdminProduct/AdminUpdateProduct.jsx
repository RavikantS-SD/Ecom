            ...
            <form onSubmit={postData}>
              ...
              <div className="row">
                <div className="col-md-6 mb-3">
                  <label>Color*</label>
                    <input type="text" name="color" value={data.color} onChange={getInputData} placeholder="Product Color"
                    className={`form-control ${
                ...
                <div className="col-md-6 mb-3">
                  <label>Size*</label>
                    <input type="text" name="size" value={data.size} onChange={getInputData}
                    className={`form-control ${
              ...
              <div className="row">
                <div className="col-md-6 mb-3">
                  ...
                  <input type="number" name="quantity" value={data.quantity} onChange={getInputData} placeholder="Product Stock Quantity"
                    className={`form-control ${
                    ...
                    <div>
                      {
                        data.pic.map((item, index) => {
                          ...
                          height={60} width={80} className="mx-1" alt="Product Pic" />
                        })
                      }
                    </div>     
                </div>
