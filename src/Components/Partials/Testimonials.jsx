...
export default function Testimonials() {
    ...
    let options = {
        ...
        nav: true,
        navText: ['<button class="btn btn-primary" style="width=100px;border-radius:80px"><i class="fa fa-arrow-right"></i></button>','<button class="btn btn-primary" style="width=100px;border-radius:80px"><i class="fa fa-arrow-left"></i></button>']
    }
    useEffect(()=>{
        (() => {
        ...
        <div className="container-fluid testimonial pb-3 my-3">
            <div className="container pb-5">
                <div className="text-center mx-auto pb-3 wow fadeInUp" data-wow-delay="0.2s" style={{maxWidth: "800px"}}>
                    <h4 className="text-primary h1">Testimonial</h4>
