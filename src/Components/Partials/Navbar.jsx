                        ...
                        <div className="col-lg-8 text-center text-lg-start mb-lg-0">
                            <div className="d-flex flex-wrap">
                                <div className="border-end border-primary pe-3">
                                    <p className="text-muted small"><i className="fas fa-map-marker-alt text-primary me-2 mt-2"></i>Village Chhallera, Sector 44, Noida</p>
                                </div>
                                <div className="ps-3 mt-1">
                                    <Link to="mailto:ravikantshrivastava39@gmail.com" target='_blank' rel='noreferrer' className="text-muted small"><i className="fas fa-envelope text-primary me-2"></i>ravikantshrivastava39@gmail.com</Link>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container">
                    <nav className="navbar navbar-expand-lg navbar-light">
                        ...
                        <div className="d-none d-xl-flex flex-shrink-0 ps-4">
                            <Link to="tel:918878364836" target='_blank' rel='noreferrer' className="btn btn-light btn-lg-square rounded-circle position-relative wow tada" data-wow-delay=".9s">
                            ...
                            <div className="d-flex flex-column ms-3">
                                ...
                                <Link to="tel:919873848046" target='_blank' rel='noreferrer'><span className="text-dark">Free: +91 8878364836</span></Link>
                            </div>
                        </div>
                            ...
                            <div className="navbar-nav mx-0 mx-lg-auto">
                                {
                                    ...
                                    <div className="nav-item dropdown">
                                        <Link to="#" className="nav-link" data-bs-toggle="dropdown">
                                            <span className="dropdown-toggle">{sessionStorage.getItem("name")}</span>
                                        </Link>
