                        ...
                        data?.map((item,index)=>{
                            ...
                            <div className="service-item">
                                <div className="service-img">
                                    <img src={item.pic[0]} style={{height:250}} className="img-fluid rounded-top w-100" alt="Product"/>
                                ...
                                <div className="service-content p-4">
                                    <div className="service-content-inner">
                                        <Link to={`/product/${item.id}`} style={{height:50}} className="d-inline-block h4 mb-4">{item.name}</Link>
