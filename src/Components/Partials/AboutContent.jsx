                ...
                <div className="row g-5">
                    <div className="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                        <div className="about-item-content bg-white rounded p-5 h-100">
                            ...
                            <p className="text-dark mb-4"><i className="fa fa-check text-primary me-3"></i>Upto 90% Off</p>
                            <Link className="btn btn-primary rounded-pill py-3 px-5" to="/">Show Now</Link>
                        </div>
                    </div>
                            ...
                            <div className="row g-4 justify-content-center">
                                <div className="col-12">
                                    <div className="rounded bg-light">
                                        <img src="img/about-1.png" className="img-fluid rounded w-100" alt="About"/>
                                    </div>
                                </div>
